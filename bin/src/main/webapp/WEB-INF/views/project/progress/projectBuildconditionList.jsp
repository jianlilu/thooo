...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="progress:projectBuildcondition:edit"><li><a href="${ctx}/progress/projectBuildcondition/form">项目信息添加</a></li></shiro:hasPermission>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>分管领导</th>
				<th>更新人</th>
				<shiro:hasPermission name="progress:projectBuildcondition:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="projectBuildcondition" varStatus="status">
			<tr>
				...
				<shiro:hasPermission name="progress:projectBuildcondition:edit"><td style="width:150px;">
