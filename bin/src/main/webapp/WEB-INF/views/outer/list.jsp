...
<script type="text/javascript"> 
	...
	function query(categoryId){
		$('#listIframe').attr("src","/outer/listIframe/" + menuFlag + "/" + categoryId + "?queryStr=" + encodeURI(encodeURI($('#queryInput').val())));
	}
</script>
</head>
...
<body>
		...
		<div class="main clear">
			<div class="left">
				...
				<div class="bread-crumbs">
					<a href="/outer">首页</a><code>></code><span>${category.name}</span>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="sub main clear">
		...
		<div class="sub-left left">
	    	<div class="box">
	            <h3 class="clear">
	                <div class="box-title left">${category.name}</div>
			...
			<div class="filter-search clear">
				<div class="small-search right">
					<div class="clear">
						...
						<a href="javascript:void(0);" class="search-btn left" onclick="query('${category.id}');">查询</a>
					</div>
				</div>
			</div>
		
			<iframe id="listIframe" src="${outUrl}/listIframe/${menuFlag}/${category.id}" name="frameName" src='' onload="Javascript:SetWinHeight(this)" width="100%" frameborder="0" scrolling="no"></iframe>
