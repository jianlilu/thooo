 ...
 */
package com.shark.base.modules.act.service.ext;
...
import com.shark.base.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.shark.base.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.shark.base.modules.sys.entity.User(null, userId)))){
