...
<div class="list-table">
	<table>
		...
		<c:if test="${page.count != 0}">
			...
			<tr>
				<td class="col-1"><a href="javascript:void(0);" class="left" target="_blank">${fns:abbr(project.projectname,80)}</a></td>
				<td class="col-2"><fmt:formatDate value="${project.updateDate}" pattern="yyyy-MM-dd"/></td>
			</tr>
			</c:forEach>
		</c:if>
	</table>
